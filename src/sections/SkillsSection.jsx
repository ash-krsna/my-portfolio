...
export function SkillsSection() {
  return (
    <section id="skills" className="section-shell">
      <SectionHeading
        eyebrow="Skills"
        title="A stack shaped by frontend precision, AI-aware interfaces, and practical technical growth."
        copy="The strongest signal I want the portfolio to give is this: I care about how things work, how they feel to use, how safely they behave, and how cleanly they can scale."
      />
      ...
      <div className="mt-14 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="premium-card p-8">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {["React", "Vite", "Agentic AI", "AI-Aware UI", "UI Systems", "Security-Aware", "Edge + IoT", "APIs", "Problem Solving"].map((item) => (
