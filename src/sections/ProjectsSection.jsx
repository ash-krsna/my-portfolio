...
export function ProjectsSection() {
  ...
  return (
    <section id="projects" className="section-shell">
      <SectionHeading
        eyebrow="Projects"
        title="Selected work with product taste, cleaner structure, and a stronger engineering signal."
        copy="Built to feel like a curated technical portfolio. Compact cards, clearer stack cues, and short case-study views that explain why the work matters."
      />
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-12">
        {projects.map((project, index) => (
          ...
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(72,194,141,0.14),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(103,190,255,0.14),transparent_24%)] opacity-80" />
            <div className="relative z-10">
              ...
              <h3 className="mt-4 font-display text-2xl text-zinc-950 dark:text-white md:text-[2rem]">{project.title}</h3>
